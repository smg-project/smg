...
# Poll interval of the lifecycle watcher (request-manager exit and the
# WorkerControl link).
_LIFECYCLE_WATCH_INTERVAL_SECS = 0.25
        ...
        while not stop_event.is_set():
            ...
            if worker_control is not None:
                ...
                if not worker_control.running or error:
                    ...
                    stop_event.set()
                    return
            await asyncio.sleep(_LIFECYCLE_WATCH_INTERVAL_SECS)
