...
use super::views::{
    ChatRequestView, CompletionRequestView, GenerateRequestView, MessagesRequestView,
};
use crate::{
...
impl StreamingProcessor {
    ...
    pub async fn process_streaming_chunks(
        ...
        original_request: ChatRequestView,
        tx: &SseSender,
        reservation: Option<Arc<SharedReservationHandle>>,
    ) -> Result<(), String> {
    ...
    pub async fn process_streaming_generate(
        self: Arc<Self>,
        execution_result: context::ExecutionResult,
        generate_request: GenerateRequestView,
        dispatch: context::DispatchMetadata,
        tokenizer: Arc<dyn Tokenizer>,
        reservation: Option<Arc<SharedReservationHandle>>,
    ) -> Response {
    ...
    pub async fn process_messages_streaming_response(
        self: Arc<Self>,
        execution_result: context::ExecutionResult,
        messages_request: MessagesRequestView,
        dispatch: context::DispatchMetadata,
        tokenizer: Arc<dyn Tokenizer>,
        skip_special_tokens: bool,
        reservation: Option<Arc<SharedReservationHandle>>,
    ...
    pub async fn process_messages_streaming_chunks(
        ...
        tokenizer: Arc<dyn Tokenizer>,
        stop_params: (Option<StringOrArray>, Option<Vec<u32>>, bool, bool, bool),
        original_request: MessagesRequestView,
        tx: &SseSender,
        reservation: Option<Arc<SharedReservationHandle>>,
    ) -> Result<(), String> {
        let start_time = Instant::now();
    ...
    pub async fn process_completion_streaming_response(
        self: Arc<Self>,
        execution_result: context::ExecutionResult,
        completion_request: CompletionRequestView,
        dispatch: context::DispatchMetadata,
        tokenizer: Arc<dyn Tokenizer>,
        reservation: Option<Arc<SharedReservationHandle>>,
    ) -> Response {
    ...
    async fn process_prefill_decode_completion_streaming_chunks(
        ...
        tokenizer: Arc<dyn Tokenizer>,
        stop_params: (Option<StringOrArray>, Option<Vec<u32>>, bool, bool, bool),
        original_request: &CompletionRequestView,
        prompt_text: &str,
        index_offset: u32,
        tx: &SseSender,
    ) -> Result<CompletionStreamOutcome, String> {
