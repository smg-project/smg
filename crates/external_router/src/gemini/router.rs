...
impl GeminiRouter {
    ...
    pub fn new(ctx: &ExternalContext) -> Result<Self, String> {
        let shared_components = Arc::new(SharedComponents {
            ...
            mcp_orchestrator: ctx.mcp_orchestrator("Gemini")?,
...
// ============================================================================
// ExternalRouter implementation
// ============================================================================

#[async_trait]
impl ExternalRouter for GeminiRouter {
    ...
    async fn route_interactions(
        ...
        let per_model_retry_config =
            model_id.and_then(|id| self.shared_components.workers.retry_config(id));
