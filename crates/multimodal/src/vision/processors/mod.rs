...
//! - **DeepSeek V4 Vision** (`deepseek_v4_vision`): Pillow-exact dynamic N-layout preprocessing
...
pub use deepseek_v4_vision::{deepseek_v4_geometry, DeepseekV4Geometry, DeepseekV4VisionProcessor};
